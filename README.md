...
Для нейтрализации синтаксических ошибок используется метод Айронса (паническое восстановление): 
...
Другими словами, в отличие от остановки на первой ошибке, анализатор при ошибке не завершает работу, а «восстанавливается» – пропускает часть входной цепочки до заранее определённого множества синхронизирующих символов (токенов), после чего пытается возобновить разбор с ближайшей корректной конструкции.
